...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QHelpIndexModel_t, stringdata) + ofs \
...
void QHelpIndexModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QHelpIndexModel::indexCreationStarted)) {
                *result = 0;
            }
        }
        {
            typedef void (QHelpIndexModel::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QHelpIndexModel::indexCreated)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject QHelpIndexModel::staticMetaObject = {
    { &QStringListModel::staticMetaObject, qt_meta_stringdata_QHelpIndexModel.data,
      qt_meta_data_QHelpIndexModel,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QHelpIndexModel.stringdata))
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QHelpIndexWidget_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
void QHelpIndexWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QHelpIndexWidget::linkActivated)) {
                *result = 0;
            }
        }
        {
            typedef void (QHelpIndexWidget::*_t)(const QMap<QString,QUrl> & , const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QHelpIndexWidget::linksActivated)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject QHelpIndexWidget::staticMetaObject = {
    { &QListView::staticMetaObject, qt_meta_stringdata_QHelpIndexWidget.data,
      qt_meta_data_QHelpIndexWidget,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QHelpIndexWidget.stringdata))
