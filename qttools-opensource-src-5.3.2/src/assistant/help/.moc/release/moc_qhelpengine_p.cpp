...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QHelpEngineCorePrivate_t, stringdata) + ofs \
...
const QMetaObject QHelpEngineCorePrivate::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QHelpEngineCorePrivate.data,
      qt_meta_data_QHelpEngineCorePrivate,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QHelpEngineCorePrivate.stringdata))
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QHelpEnginePrivate_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
const QMetaObject QHelpEnginePrivate::staticMetaObject = {
    { &QHelpEngineCorePrivate::staticMetaObject, qt_meta_stringdata_QHelpEnginePrivate.data,
      qt_meta_data_QHelpEnginePrivate,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QHelpEnginePrivate.stringdata))
