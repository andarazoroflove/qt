...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QHelpContentModel_t, stringdata) + ofs \
...
void QHelpContentModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QHelpContentModel::contentsCreationStarted)) {
                *result = 0;
            }
        }
        {
            typedef void (QHelpContentModel::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QHelpContentModel::contentsCreated)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject QHelpContentModel::staticMetaObject = {
    { &QAbstractItemModel::staticMetaObject, qt_meta_stringdata_QHelpContentModel.data,
      qt_meta_data_QHelpContentModel,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QHelpContentModel.stringdata))
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QHelpContentWidget_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
...
void QHelpContentWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QHelpContentWidget::linkActivated)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject QHelpContentWidget::staticMetaObject = {
    { &QTreeView::staticMetaObject, qt_meta_stringdata_QHelpContentWidget.data,
      qt_meta_data_QHelpContentWidget,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QHelpContentWidget.stringdata))
