...
struct qt_meta_stringdata_fulltextsearch__clucene__QHelpSearchIndexWriter_t {
    QByteArrayData data[4];
    char stringdata[82];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_fulltextsearch__clucene__QHelpSearchIndexWriter_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_fulltextsearch__clucene__QHelpSearchIndexWriter_t qt_meta_stringdata_fulltextsearch__clucene__QHelpSearchIndexWriter = {
    {
QT_MOC_LITERAL(0, 0, 47),
QT_MOC_LITERAL(1, 48, 15),
...
const QMetaObject fulltextsearch::clucene::QHelpSearchIndexWriter::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_fulltextsearch__clucene__QHelpSearchIndexWriter.data,
      qt_meta_data_fulltextsearch__clucene__QHelpSearchIndexWriter,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_fulltextsearch__clucene__QHelpSearchIndexWriter.stringdata))
