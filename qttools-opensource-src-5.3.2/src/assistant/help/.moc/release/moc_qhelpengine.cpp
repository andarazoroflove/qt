...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QHelpEngine_t, stringdata) + ofs \
...
const QMetaObject QHelpEngine::staticMetaObject = {
    { &QHelpEngineCore::staticMetaObject, qt_meta_stringdata_QHelpEngine.data,
      qt_meta_data_QHelpEngine,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QHelpEngine.stringdata))
