...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QFont_t, stringdata) + ofs \
...
static const uint qt_meta_data_QFont[] = {
 ...
 // enum data: key, value
      ...
      13, uint(QFont::NoFontMerging),

       0        // eod
};

const QMetaObject QFont::staticMetaObject = {
    { 0, qt_meta_stringdata_QFont.data,
      qt_meta_data_QFont,  0, 0, 0}
};
