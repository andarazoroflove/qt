...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QEventDispatcherWin32_t, stringdata) + ofs \
...
const QMetaObject QEventDispatcherWin32::staticMetaObject = {
    { &QAbstractEventDispatcher::staticMetaObject, qt_meta_stringdata_QEventDispatcherWin32.data,
      qt_meta_data_QEventDispatcherWin32,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QEventDispatcherWin32.stringdata))
