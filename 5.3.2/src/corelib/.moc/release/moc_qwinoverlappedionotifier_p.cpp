...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QWinOverlappedIoNotifier_t, stringdata) + ofs \
...
void QWinOverlappedIoNotifier::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: { OVERLAPPED* _r = _t->d_func()->_q_notified();
            if (_a[0]) *reinterpret_cast< OVERLAPPED**>(_a[0]) = _r; }  break;
        default: ;
        }
...
const QMetaObject QWinOverlappedIoNotifier::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QWinOverlappedIoNotifier.data,
      qt_meta_data_QWinOverlappedIoNotifier,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QWinOverlappedIoNotifier.stringdata))
