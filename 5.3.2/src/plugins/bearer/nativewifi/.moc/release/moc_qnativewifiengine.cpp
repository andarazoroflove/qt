...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QNativeWifiEngine_t, stringdata) + ofs \
...
const QMetaObject QNativeWifiEngine::staticMetaObject = {
    { &QBearerEngineImpl::staticMetaObject, qt_meta_stringdata_QNativeWifiEngine.data,
      qt_meta_data_QNativeWifiEngine,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QNativeWifiEngine.stringdata))
