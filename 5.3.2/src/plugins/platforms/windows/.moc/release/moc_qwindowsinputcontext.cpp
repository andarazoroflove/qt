...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QWindowsInputContext_t, stringdata) + ofs \
...
const QMetaObject QWindowsInputContext::staticMetaObject = {
    { &QPlatformInputContext::staticMetaObject, qt_meta_stringdata_QWindowsInputContext.data,
      qt_meta_data_QWindowsInputContext,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QWindowsInputContext.stringdata))
