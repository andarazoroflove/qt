...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QGraphicsAnchor_t, stringdata) + ofs \
...
const QMetaObject QGraphicsAnchor::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QGraphicsAnchor.data,
      qt_meta_data_QGraphicsAnchor,  qt_static_metacall, qt_meta_extradata_QGraphicsAnchor, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QGraphicsAnchor.stringdata))
