...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QGraphicsSceneLinearIndex_t, stringdata) + ofs \
...
const QMetaObject QGraphicsSceneLinearIndex::staticMetaObject = {
    { &QGraphicsSceneIndex::staticMetaObject, qt_meta_stringdata_QGraphicsSceneLinearIndex.data,
      qt_meta_data_QGraphicsSceneLinearIndex,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QGraphicsSceneLinearIndex.stringdata))
